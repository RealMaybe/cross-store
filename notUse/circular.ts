...
type CircularItem = Record<string | symbol, unknown> | Array<unknown>;
 ...
 * @returns {{ isCircular: boolean; value: undefined }} 检测结果
 */
export function circularFilter<T extends CircularItem>(
    item: T
): { isCircular: boolean; value: undefined };
 ...
 * @returns { { isCircular: boolean; value: T } } 处理结果（无循环引用时返回原对象）
 */
export function circularFilter<T extends CircularItem>(
    item: T,
    filter: true
): { isCircular: boolean; value: T };
 ...
 * @returns { { isCircular: boolean; value: T | undefined } } 处理结果
 */
export function circularFilter<T extends CircularItem>(
    item: T,
    filter?: boolean
): { isCircular: boolean; value: T | undefined } {
